...
// //     const updatedItem = { ...itemQ, quantity: updatedQty };
// //     dispatch(adjustQty(updatedItem)); // Dispatch an action to update the quantity of the user_item
// //     const updatedCartItems = currentUser?.user_items?.map((cartItem) =>
// //       cartItem.id === updatedItem.id ? updatedItem : cartItem
// //     )
// //     dispatch(updateCart(updatedCartItems)); // Dispatch an action to update the currentUser’s user_items array
// //     navigate('/checkout');
// //   };
// const handleAddItem = () => {
//     // const updatedQty = parseInt(qty)
